 ...
 * Exposes: POST /api/ocr  ->  body: { "pdf_url": "https://example.com/file.pdf" }
 *
 * Run:
 *   npm install express axios form-data dotenv pdf-parse @napi-rs/canvas
 *   node server.js
 */
